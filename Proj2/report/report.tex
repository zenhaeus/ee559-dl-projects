...
% TODO: mention that minibatches can be handled properly
...
% TODO: explain how models were compared to ensure that our implementation was correct -> show that for uniformly initialized weights both models behave exactly the same
